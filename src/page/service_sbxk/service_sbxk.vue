        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>商标许可备案</p></div>
                                <!-- 中间内容 -->
                ...
                data(){
                        return{
                                title:['申请主体','流程周期','业务介绍','服务优势','常见问题'],
                                                ...
                                                question:[],
                                                title_color:'',
                                                title_all:["申请主体","商标许可备案申请流程","业务介绍","服务优势",'常见问题'],
                                                ...
                                                pub:{//公共问题
                                                        arrq:[
                                                            ...
                                                            {q: '同时办理几件商标许可备案可以只签订一份合同吗？',
                                                             ...
                                                             {q: '商标许可备案要注意什么？',
                                                             a: '在合同签订之日起3 个月内进行备案；超过有效期限及核准注册的商品，不予备案。许可合同中必备条款：许可使用的商标、注册号、商品范围、年限及商标的标识提供方式。对被许可人的商品质量接受许可人监督，在使用许可商品上标明被许可人的名称和商品产地条款。'},
                                                             {q: '办理成功后，会下发新的商标注册证吗？',
