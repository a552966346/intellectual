        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>单独国家直接申请</p></div>
                                <!-- 中间内容 -->
                        ...
                        return{
                                ...
                                pub:{//公共问题
                                        arrq:[
                                                ...
                                                {q: '申请美国专利需要准备哪些文件？',
                                                a: `（1）巴黎公约途径：在中国申请后，在第一在先专利申请日（即优先权日）起12个月届满前向美国知识产权局提出美国专利申请，可以享受优先权的待遇，需要提交优先权证明文件。申请所需文件及信息：申请文件：包括说明书、权利要求书、说明书附图、摘要、摘要附图；申请信息：申请人及发明人中英文名称姓名、地址及邮编，申请国家，联系人等；优先权信息；委托书；（2）PCT途径：根据PCT的规定，申请人可以通过PCT途径递交国际申请，指定向全球几乎所有国家申请专利，即在中国在先申请的申请日（优先权日）起12个月内向中国国家知识产权局提出PCT国际申请，在自优先权日起30个
                                                月内向美国知识产权局提出进入申请。申请所需文件：PCT公开文件；国际检索报告；PCT阶段的修改文件（如有）；委托书。`
                                                },
                                        ]
...
<style scoped>
        * {margin:0;padding:0;box-sizing:border-box;}
        ...
        .zzdj_cen_right{display: flex;flex-direction: column;overflow: hidden;background-color: #fff;font-size: 15px;}
