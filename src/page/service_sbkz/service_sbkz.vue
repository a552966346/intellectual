        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>商标宽展</p></div>
                                <!-- 中间内容 -->
        ...
        export default{
                ...
                data(){
                        return{
                                                ...
                                                question:[],
                                                title_color:'',
                                                title_all:["申请主体","商标宽展申请流程","业务介绍","服务优势",'常见问题'],
                                                ...
                                                pub:{//公共问题
                                                    arrq:[
                                                            {q: '商标宽展后的有效期是多久？',
                                                             a: '商标宽展注册的有效期为10年，不限宽展次数。'},
                                                            {q: '关于商标宽展和商标续展有什么区别？',
                                                             a: '商标续展是注册商标有效期为10年，期满需要继续使用的，应当在期满前六个月内申请。宽展是在规定的续展期限内未能提出续展申请的，可给予六个月宽限期。'},
                                                             {q: '没有按时申请商标续展或宽展，会导致什么后果？',
                                                             a: '持有的商标过期失效，持有人失去商标专用权。'},
                                                             {q: '办理成功后，会重新下发新的商标注册证吗？',
                                                             a: '续展或宽展失去不下发受理通知书，下发的是《核准续展注册证明》，上面会写明续展后的商标权有效的起始日和终止日，注意原商标注册证也要妥善保管，以便和续展证明一起使用。'}
