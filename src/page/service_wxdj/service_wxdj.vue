        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>文学作品登记</p></div>
                                <!-- 中间内容 -->
                ...
                data(){
                        return{
                               ...
                               title:['服务详情','申请流程','服务保障','常见问题'],
                                ...
                                question:[],
                                title_color:'',
                                title_all:["文学作品登记的必要性？","文学作品登记流程","服务保障","常见问题"],
                                ...
                                pub:{//公共问题
                                    arrq:[
                                            ...
                                            {q: '版权登记之后得到哪些证书？',
                                             a: '版权登记之后，重庆市版权局盖章认证的《作品登记证书》和盖章的作品样本。'},
                                             {q: '作品登记后在哪里可以查看？',
                                             a: '作品登记后可以在重庆市版权局或者重庆市版权保护中心网站进行查看。'},
                                            {q: '办理的作品登记全国通用吗？',
