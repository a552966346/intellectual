...
export default {
  ...
  data() {
    return {
      ...
      //交易中心组件所需侧边图片
      pay_img_list: [
        "../../../static/img/index/zhuanli_pay.png",
      ...
      list: [
        {
          ...
          miney: "398.00元",
          listimg: "../../../static/img/index/index_icon.png",
          btntit: "联系客服",
          btntitw: "查看详情",
        },
        {
      ...
      parlist: [
        ...
        {
          index: 2,
          parimg: "../../../static/img/index/index_partnertw.png",
          paron: "01",
          partw: "成为代理商",
        },
        {
          index: 3,
          parimg: "../../../static/img/index/index_partnertr.png",
          paron: "02",
          partw: "提交客户商机",
        },
        {
          index: 4,
          parimg: "../../../static/img/index/index_partnerfh.png",
          paron: "03",
          partw: "伊甸城知产服务",
        },
        {
          index: 5,
          parimg: "../../../static/img/index/index_partnerfv.png",
          paron: "04",
          partw: "获得利润分成",
        },
      ],
