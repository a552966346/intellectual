...
<style scoped>
     ...
     .index_ulxwtwbk{width: 100%;height: 100px;background-color: #fff;display: flex;justify-content: center;align-content: center;flex-direction: row;margin-bottom: 15px;}
      ...
      .newa>div:nth-child(2){flex: 1;display: flex; align-items: center;padding: 10px;}
      .index_ulxwtwbkrt{height: 100%;display: flex;justify-content: center;align-content: center;flex-direction: column;padding: 15px;}
      .index_ulxwas{line-height: 1.7;padding-top: 10px; width: 100%;display: flex;align-content: center;border-left: 1px solid #ccc;overflow: hidden;font-size: 12px;color: #187fc4;padding-left: 20px;padding-right: 15px;}
      .index_ulxwas1{ width: 100%;display: flex;align-content: center;border-left: 1px solid #ccc;overflow: hidden;font-size: 12px;color: #187fc4;padding-left: 20px;padding-right: 15px;}
