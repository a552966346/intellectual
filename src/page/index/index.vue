<template>
  <div>
    ...
    <div class="index_pay">
      ...
      <v-comtitle
        :title="title_all[0]"
        :background_img_url="title_bg_url[0]"
        :inform_title="title_text_all[0]"
      ></v-comtitle>
      <!-- 专利交易 -->
      <v-indexpayitem
        :payleft_img_url="pay_img_list[0]"
        :hot="hot"
      ...
      <!-- 商标交易 -->
      <v-indexpayitem
        :payleft_img_url="pay_img_list[1]"
        :trade="trade"
        :num="num2 + ''"
      ></v-indexpayitem>
      <!-- 软著交易 -->
      <v-indexpayitem
        :payleft_img_url="pay_img_list[2]"
        :istrades="soft"
        :num="num3 + ''"
      ></v-indexpayitem>
    </div>
    ...
    <div class="index_enterprise">
      <v-comtitle
        :title="title_all[1]"
        :color="title_color"
        :inform_title="title_text_all[1]"
        :background_img_url="title_bg_url[1]"
      ></v-comtitle>
    ...
    <div class="index_content">
      ...
      <div class="partner">
        <v-comtitle
          ...
          :inform_title="title_text_all[4]"
        ></v-comtitle>
        <div class="index_partner">
          <div
            :class="index.index == 1 ? 'index_partblok' : 'index_partblak'"
            v-for="(index, item) in parlist"
            :key="item"
            @click="open(item)"
          >
      ...
      <div class="index_about">
        <v-comtitle
          :title="title_all[5]"
          :background_img_url="title_bg_url[5]"
          :inform_title="title_text_all[5]"
        ></v-comtitle>
        <div class="index_about1">
          <div class="index_about_content">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div
                    class="swiper-slide"
                    :key="index"
                    v-for="(item, index) in introimage"
                  >
                    <img :src="item" alt="" />
                  </div>
                </div>
            ...
            <div class="index_right_content">
              ...
              <img
                src="../../../static/img/index/about_right_three.png"
                alt=""
              />
            </div>
          </div>
    ...
    <div class="layui" v-show="isshow" @click.self="close">
      <div class="layui_left">
        <div class="layui_title" style="display: flex">
          <div>
            <h2>申请成为合伙人</h2>
            <span style="color: #ccc; font-size: 15px; padding-left: 5px"
              ><img src="" alt="" />最高100%返佣</span
            >
          </div>
          <div @click="close">
          ...
          <div class="layui_cent">
            ...
            >
              ...
              <el-form-item label="联系人" prop="name" class="login_form_item">
                <el-input
                  type="text"
                  v-model="login_ruleForm.name"
                  size="large"
                  style="width: 100%"
                  autocomplete="off"
                  placeholder="如王女士/张女士"
                ></el-input>
              </el-form-item>
    ...
    return {
      ...
      nulist: [
        ...
        },
        {
          ...
          center:
            "各市、县人民政府，省人民政府各委、办、厅、局：为深入贯彻落实《国务院关于新形势下加快知...》",
        },
        {
          index: 3,
          title: "山西省专利实施和保护条例",
          center:
            "（2001年11月25日山西省第九届人民代表大会常务委员会第二十六次会议通过 2014年...）",
        },
      ],
      // 伊甸网
      brief: "",
