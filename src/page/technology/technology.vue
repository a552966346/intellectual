<template>
  <div>
    ...
    <div class="technology_list">
      <v-search
        :payleft_img_url="payleft_img_url[0]"
        :transfer="transfer"
      ></v-search>
    </div>
    <!-- 最新需求 -->
    <div class="technology_list">
      ...
      <v-demand
        :payleft_img_url="payleft_img_url[1]"
        :demand="newneed"
      ></v-demand>
    </div>
    <!-- 高附加值服务 -->
    ...
    <v-comtitle
      :title="title_all[2]"
      :color="title_color"
      :background_img_url="title_bg_url[2]"
    ></v-comtitle>
    <div class="technology_list">
      <!-- <v-toplist :rank="ranking"></v-toplist> -->
      <v-technologyHot  :option="option" ></v-technologyHot>
    </div>
...
<script>
        ...
        import technologyHot from '@/components/technology/technologyHot.vue';
...
.technology_sousuo {
  ...
  padding: 40px 50px;
  border-radius: 5px;
  background-image: url(../../../static/img/technology/dbbgimg.png);
