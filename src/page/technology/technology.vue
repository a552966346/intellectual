...
export default {
  ...
  data() {
    return {
      ...
      addall: [
        {
          ...
          title: "专利服务",
          cont:
            "专利服务其实是知BAI知产权里边的一个服DU之一，同时也是一个重要的服务之一。",
        },
        {
          ...
          title: "商标服务",
          cont:
            "服务商标与商品商标具有相同的特征与特点。区别在与服务商标意识的是服务项目，商品商标标识的是有形商品。",
        },
        {
      ...
      project: {
        cont:
          "伊甸城知识产权展示交易中心以服务高校科研院所及科创企业知识产权成果转移转化为核心，致力于建设知识产权登记、托管、挂牌、交易、转化、运营、融资、保护为一体的专业化、规范化的知识产权产业链生态平台，构建知识产权及知识产权运营及知识产权融资服务体系并探索知识产权产业化、资本化、国际化道路。",
        pic: [
