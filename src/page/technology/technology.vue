<template>
        <div>
                ...
                <div class="technology_transfer">
                        <v-comtitle :title="title_all[0]" :color="title_color" :background_img_url="title_bg_url[0]"></v-comtitle>
                </div>
                <!-- 技术转让 -->
                ...
                <!-- 高附加值服务 -->
                <v-comtitle :title="title_all[1]" :color="title_color" :background_img_url="title_bg_url[1]"></v-comtitle>
                <div class="technology_list">
                        <v-addition :add="addall"></v-addition>
                </div>

                <!-- 专利排行榜 -->
                <v-comtitle :title="title_all[2]" :color="title_color" :background_img_url="title_bg_url[2]"></v-comtitle>
                <div class="technology_list">
                        <v-technologyHot :option="option"></v-technologyHot>
                </div>

                <!-- 项目对接与推荐 -->
                <v-comtitle :title="title_all[3]" :color="title_color" :background_img_url="title_bg_url[3]"></v-comtitle>
                <div class="technology_list">
