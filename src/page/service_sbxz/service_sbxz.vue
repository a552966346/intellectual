        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>商标续展</p></div>
                                <!-- 中间内容 -->
                        ...
                        return{
                               title:['申请主体','流程周期','业务介绍','服务优势','常见问题'],
                                               ...
                                               pub:{//公共问题
                                                   arrq:[
                                                            {q: '未在有效期内及时商标续展，怎么办？',
                                                             a: '已注册的商标期满之日起6个月内希望仍继续保有该商标，可以办理商标宽展申请，继续保有该商标。'},
                                                            {q: '商标续展后的有效期是多久？',
                                                             a: '商标续展可以延长商标专用权10年，不限续展次数。'},
                                                             {q: '办理成功后，商标局会发受理通知书吗？',
                                                             a: '续展申请不下发受理通知书，下发的是《核准续展注册证明》，上面会写明续展后的商标权有效的起始日和终止日，注意原商标注册证也要妥善保管，以便和续展证明一起使用。'},
                                                             {q: '为什么要及时办理商标续展？',
                                                             a: '商标注册在有效期满前，商标所有人应及时在商标注册机关办理续展注册手续。不要使商标过期失效，失去商标专用权。'}
                                                   ]
                                               },
                                               //服务优势
                                                yst:[{
