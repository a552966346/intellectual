        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                                <div class="consultation_all_text"><p style="font-size: 15px; color: #666;"><router-link to="/copyright" style="color: #666;">版权交易</router-link>>{{top_data.name}}</p></div>
                                <!-- 中间内容 -->
...
<script>
        import servicetop from '../../components/servicetop/servicetop_seven.vue'
