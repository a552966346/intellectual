        ...
        <div>
                ...
                <div class="consultation_all">
                        ...
                        <div class="consultation_all_Center">
                               <div class="consultation_all_text"><p style="font-size: 13px; color: #666;"><router-link to="/servicecenter" style="color: #666;">服务中心</router-link>>外观设计</p></div>
                                <!-- 中间内容 -->
        ...
        export default{
                ...
                data(){
                        return{
                                ...
                                question:[],
                                title_color:'',
                                title_all:["什么是外观设计？","哪些发明创造可以申请发明专利？","发明专利能给带来什么好处?","为什么选择伊甸城？","外观设计申请流程","服务保障","常见问题"],
