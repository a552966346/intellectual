                ...
                <div class="tanchuang_all">
                        ...
                        <div class="tanchuang_body">
                                ...
                                <el-form ref="formrul" :model="form2" label-width="100px" :rules="formrule">
                                        ...
                                        <el-form-item>
                                                <el-button type="primary" style="color: #fff; background: #2b3d63; width: 42%;margin-bottom:20px" @click="fabu('formrul')">确认发布</el-button>
                ...
                methods: {
                       ...
                       fabu(fromname) {
                               this.$refs[fromname].validate((valid) => {
                                       this.$api.getrankingpost( this.form2.name,this.select,this.form2.num, this.form2.minprice, this.form2.tel,this.form2.authcode,2)
                                               .then(res => {
                                                       console.log(res)
                                                       if (res.code == 1) {
                                                               this.$message({
